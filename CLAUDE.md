...
- `--judge-diagnosis` — also score each diagnosis's groundedness + completeness with the LLM judge (needs `--failure-analysis`; adds one judge call per failed test)
